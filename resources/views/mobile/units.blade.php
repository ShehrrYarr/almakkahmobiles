            ...
            <div class="col-xxl-12 col-xl-12 col-lg-12 col-md-12 col-12 latest-update-tracking mt-1">
                <div class="card">
                    <div class="card-header latest-update-heading d-flex justify-content-between">
                        <h4 class="latest-update-heading-title text-bold-500">All Mobile Units</h4>
                    </div>
                    <div class="table-responsive">
                        <table id="mobileUnitsTable" class="table table-striped table-bordered zero-configuration">
                            <thead>
                                <tr>
                                    <th>Purchase Date</th>
                                    <th>Photos</th>
