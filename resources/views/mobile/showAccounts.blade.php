    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form class="form" id="storeMobile" action="{{ route('mobile.creditAmount') }}" method="post"
...
<div class="modal fade" id="exampleModal1" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form class="form" id="editmobile" action="{{ route('mobile.debitAmount') }}" method="post"
                    enctype="multipart/form-data">
                    @csrf
                    <div class="form-body">
                        <div class="mb-1">
...
<div class="modal fade" id="exampleModal2" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form class="form" id="deleteMobile" action="{{ route('mobile.destroyAccount') }}" method="post"
                    enctype="multipart/form-data">
                    @csrf
                    <div class="form-body">
                        <div class="mb-1">
...
<style>
    ...
    .gradient-button { background: linear-gradient(to right, #74a8e0, #1779e2); border-color: #007bff; color: white; }
    .gradient-button1 { background: linear-gradient(to right, rgb(224, 199, 116), rgb(226, 168, 23)); border-color: rgb(255, 162, 0); color: white; }
</style>
            ...
            <div class="col-xxl-12 col-xl-12 col-lg-12 col-md-12 col-12 latest-update-tracking mt-1">
                <div class="card">
                    <div class="card-header latest-update-heading d-flex justify-content-between">
                        <h4 class="latest-update-heading-title text-bold-500">Account Details of <b>{{ $vendor->name }}</b></h4>
                    </div>
...
<script>
    $(document).ready(function () {
        var table = $('#accountsTable').DataTable({ order: [[0, 'asc']] });
        ...
        function recalcBalance() {
            ...
            table.rows({ order: 'applied', search: 'applied' }).every(function () {
                ...
                if (runningBalance > 0) $cell.addClass('text-danger');
                else if (runningBalance < 0) $cell.addClass('text-success');
                else $cell.addClass('text-muted');
            });
        }

        table.on('draw', function () { recalcBalance(); });
        recalcBalance();
    });
